        ...
        <div id="modal_how_import" class="uk-flex-top" uk-modal>
            <div class="uk-modal-dialog uk-margin-auto-vertical">
                ...
                <div class="uk-modal-body">
                    ...
                    <img data-src="img/screen_export.jpg" width="60%" height="" alt="" uk-img class="uk-margin-auto uk-display-block">
                </div>
            </div>
        </div>
        ...
        handleCommaAndDate(JSONData){
            ...
            JSONData.forEach(function(el,idx){
                if(typeof(JSONData[idx].amount)=="string"){
                    JSONData[idx].amount= parseFloat(JSONData[idx].amount.replace(/,/g, ''));                    
                }                  
                 JSONData[idx].date = 
                    moment(JSONData[idx].date,'DD/MM/YYYY').toDate();      
            });
